...
KTU_biorec_quan=read.csv("KTU.table.summary_quantitative_daughter_Y2_first110day.csv")
KTU_biorec_quan_D4 <- (KTU_biorec_quan[,(332:441)])
...
# # Match the same rows with the original dataset
# matched_rows <- KTU_biorec_quan[row_numbers, c(1,332:441)] 
# # Save the matched_rows to a CSV file
# write.csv(matched_rows, file = "matched_rows.csv", row.names = FALSE)

####omit NA terms from combined file

# biorec2 <- cbind(D4_reactor_Expertise,filtered_df)
# biorec2 <- na.omit(biorec2)
