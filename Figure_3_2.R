...
#KTU_biorec_rel=read.csv("KTU.table.summary_relative_abundance_daughter_Y2_first110day.csv")

KTU_biorec_quan_D4 <- (KTU_biorec_quan[,(332:441)])
#KTU_biorec_rel_D4 <- (KTU_biorec_rel[,(332:441)])
...
###########################################################################################
###### KTU table analysis
# non zero rows elimination of KTU table
