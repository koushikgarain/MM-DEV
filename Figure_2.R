...
mat_Isomap_T <- read.csv("Data\\lot_vol_6_1_Isomap.csv")
mat_Isomap_S <- read.csv("Data\\lot_vol_6_2_Isomap.csv")
...
# # for time series plot with 1000 points only
kk1=read.csv("Data\\Ricker21_1000.csv",header=T)
